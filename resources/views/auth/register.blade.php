                ...
                <div class="card-body p-4 bg-white">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="nim_nip" type="text" class="form-control @error('nim_nip') is-invalid @enderror" name="nim_nip" value="{{ old('nim_nip') }}" required autocomplete="nim_nip" placeholder="Contoh: D0221001">
                            @error('nim_nip')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-4">
                            <label for="password-confirm" class="form-label text-muted small fw-semibold">Konfirmasi Password</label>
                        ...
                        <div class="text-center mt-4">
                            <p class="small text-muted mb-0">Sudah memiliki akun? <a href="{{ route('login') }}" class="text-decoration-none text-unsulbar fw-semibold">Login</a></p>
                        </div>
                    </form>
                </div>
            </div>
