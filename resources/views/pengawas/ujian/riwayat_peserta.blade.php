...
@section('sidebar-menu')
    <a href="{{ route('pengawas.dashboard') }}"
        class="list-group-item list-group-item-action bg-transparent {{ request()->routeIs('pengawas.dashboard') ? 'active text-nowrap' : 'text-nowrap' }}">
        <i class="bi bi-speedometer2 sidebar-icon"></i> <span class="sidebar-text">Dashboard</span>
    </a>
    <a href="{{ route('pengawas.password') }}"
        class="list-group-item list-group-item-action bg-transparent {{ request()->routeIs('pengawas.password') ? 'active text-nowrap' : 'text-nowrap' }}">
        <i class="bi bi-key sidebar-icon"></i> <span class="sidebar-text">Ubah Password</span>
    </a>
@endsection
