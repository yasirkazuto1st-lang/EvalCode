...
<head>
    ...
    <style>
        ...
        #sidebar-wrapper {
            ...
            background: linear-gradient(180deg, var(--bs-primary) 0%, #3a0000 100%); /* Premium Gradient */
            transition: all 0.3s;
            color: white;
            z-index: 1000;
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper" class="sidebar">
            ...
            <div class="list-group list-group-flush mt-3 flex-grow-1 d-flex flex-column">
                ...
                @endphp
                <a href="{{ $pwdRoute }}" class="list-group-item list-group-item-action bg-transparent {{ $isPwdActive ? 'active' : '' }}">
                ...
                <div class="mt-auto">
                    <a href="{{ route('logout') }}" 
                       ...
                       class="list-group-item list-group-item-action btn-logout rounded-0">
                        <i class="bi bi-box-arrow-right sidebar-icon"></i> <span class="sidebar-text fw-bold">Logout</span>
                    </a>
                </div>
                ...
                <div class="w-100 d-flex justify-content-end align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="text-end d-none d-sm-block">
                            <div class="fw-bold text-dark" style="font-size: 0.9rem; line-height: 1.2;">{{ Auth::user()->name ?? 'Administrator' }}</div>
                            <span class="badge bg-light text-secondary border mt-1" style="font-size: 0.65rem; font-weight: 600; letter-spacing: 0.5px;">{{ Auth::user()->role ?? 'Role' }}</span>
                        </div>
                        <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm text-white fw-bold border border-2 border-white" style="width: 42px; height: 42px; background: linear-gradient(135deg, var(--bs-primary) 0%, #4a0000 100%);">
