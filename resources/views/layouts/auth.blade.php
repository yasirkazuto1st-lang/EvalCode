...
<head>
    ...
    <style>
        ...
        .code-1 { top: 5%; left: 4%; font-size: 1.1rem; }
        .code-5 { top: 35%; left: 2%; font-size: 1.35rem; }
        .code-10 { bottom: 35%; left: 4%; font-size: 1.15rem; }
        .code-3 { bottom: 5%; left: 8%; font-size: 0.9rem; }
        
        .code-4 { top: 8%; right: 6%; font-size: 0.85rem; }
        .code-9 { top: 32%; right: 3%; font-size: 0.95rem; }
        .code-6 { bottom: 38%; right: 2%; font-size: 1.05rem; }
        .code-2 { bottom: 8%; right: 5%; font-size: 1.4rem; }

        .code-7 { top: 2%; left: 40%; font-size: 0.8rem; }
        .code-8 { bottom: 2%; right: 40%; font-size: 1.2rem; }
    </style>
</head>
<body class="auth-bg">
