...
3. **Komponen UI & Monaco Editor**:
   ...
   - **Navigasi Sidebar**: Khusus pada mode gelap (*Dark Mode*), bayangan kotak (*box shadow*) pada item navigasi sidebar dinonaktifkan (`box-shadow: none !important`) agar tampilan visual sidebar tampak lebih bersih dan minimalis.
